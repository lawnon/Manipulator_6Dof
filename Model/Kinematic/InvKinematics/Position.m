...
switch dhp
    case 1
        [thr1,thr2,thr3] = Position1(x,y,z,accu,dhp,elbow);
    case 2
        [thr1,thr2,thr3] = Position2(x,y,z,accu,dhp);
end
end


function [thr1,thr2,thr3] = Position1(x,y,z,accu,dhp,elbow)
% Berechnung der Positionsgebenden Gelenkstellung d.h. th1, th2 und th3
% 
% TMat = |RotationsMatrix(3x3) Verschiebung(3,1)|
%        |      0                     1         |
...
A = 2*z*a(2);
B = -2*x*cos(thr1)*a(2)-2*y*sin(thr1)*a(2)+2*a(1)*a(2);
...
thr3 = atan2((-x*cos(thr1)-y*sin(thr1)-a(2)*sin(thr2)+a(1)), (z-a(2)*cos(thr2)))-thr2;
thr3 = real(thr3);
thr3 = round(thr3,accu);
end

function [thr1,thr2,thr3] = Position2(x,y,z,accu,dhp)
% Berechnung der Positionsgebenden Gelenkstellung d.h. th1, th2 und th3
% 
% TMat = |RotationsMatrix(3x3) Verschiebung(3,1)|
%        |      0                     1         |
